...
G1_Subject13 <- "G1_Subject13.csv"
G1_Subject14 <- "G1_Subject14.csv"
G1_Subject17 <- "G1_Subject17.csv"
G2_Subject2 <- "G2_Subject2.csv"
G2_Subject3 <- "G2_Subject3.csv"
G2_Subject5 <- "G2_Subject5.csv"
G2_Subject6 <- "G2_Subject6.csv"
G2_Subject7 <- "G2_Subject7.csv"
G2_Subject8 <- "G2_Subject8.csv"
G2_Subject9 <- "G2_Subject9.csv"
G2_Subject10 <- "G2_Subject10.csv"
G2_Subject11 <- "G2_Subject11.csv"
G2_Subject12 <- "G2_Subject12.csv"
G2_Subject14 <- "G2_Subject14.csv"
G2_Subject15 <- "G2_Subject15.csv"
G2_Subject16 <- "G2_Subject16.csv"
G3_Subject1 <- "G3_Subject1.csv"
G3_Subject2 <- "G3_Subject2.csv"
G3_Subject3 <- "G3_Subject3.csv"
G3_Subject4 <- "G3_Subject4.csv"
G3_Subject5 <- "G3_Subject5.csv"
G3_Subject6 <- "G3_Subject6.csv"
G3_Subject7 <- "G3_Subject7.csv"
G3_Subject8 <- "G3_Subject8.csv"
G3_Subject9 <- "G3_Subject9.csv"
G3_Subject10 <- "G3_Subject10.csv"
G3_Subject11 <- "G3_Subject11.csv"
G3_Subject12 <- "G3_Subject12.csv"
G3_Subject14 <- "G3_Subject14.csv"
G3_Subject15 <- "G3_Subject15.csv"
G3_Subject16 <- "G3_Subject16.csv"
G3_Subject17 <- "G3_Subject17.csv"

dataframes <- list(
  #G1_Subject13, G1_Subject14, G1_Subject17,
   #                G2_Subject2, G2_Subject3, G2_Subject5, G2_Subject6,
    #               G2_Subject7, G2_Subject8, G2_Subject9, G2_Subject10,
     #              G2_Subject11, G2_Subject12, G2_Subject14, G2_Subject15,
      #             G2_Subject16, G3_Subject1, G3_Subject2, G3_Subject3,
       #            G3_Subject4, G3_Subject5, 
                    G3_Subject6)
                    #G3_Subject7,
        #           G3_Subject8, G3_Subject9, G3_Subject10, G3_Subject11,
         #          G3_Subject12, G3_Subject14, G3_Subject15, G3_Subject16,
          #         G3_Subject17)

# Loop through each dataframe
for (file_name in dataframes) {

# For sheets with normal CAN0 data 
# For sheets 13,14,17,19,20,22-29,31-45,47-50
...
vbox_data <- data %>%
  ...
  drop_na() %>%
  mutate(time_converted = as.POSIXct(sprintf("%06.1f", time), format = "%H%M%OS", tz = "UTC"))
...
# Print the correlation matrix
print("Initial correlation matrix for speed data:")

...
G1_Subject1 <- "G1_Subject1.csv"
G1_Subject2 <- "G1_Subject2.csv"
G1_Subject4 <- "G1_Subject4.csv"
G1_Subject5 <- "G1_Subject5.csv"
G1_Subject6 <- "G1_Subject6.csv"
G1_Subject7 <- "G1_Subject7.csv"
G1_Subject8 <- "G1_Subject8.csv"
G1_Subject9 <- "G1_Subject9.csv"
G2_Subject1 <- "G2_Subject1.csv"

dataframes <- list(G1_Subject1, G1_Subject2, G1_Subject4,
                   G1_Subject5, G1_Subject6, G1_Subject7, G1_Subject8,
                   G1_Subject9, G2_Subject1)
